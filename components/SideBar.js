...
import { Button, TextField, Typography, Avatar, InputAdornment, Box, List, ListItem, ListItemAvatar, ListItemText } from '@mui/material';
    ...
    return (
        <Box p={2} style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "start" }}>
            ...
            <TextField
                ...
                style={{ backgroundColor: 'rgba(255, 255, 255, 0.09)', borderRadius: 8, color: 'white', width: '95%', marginLeft: '8px' }}
                InputProps={{
                    style: { color: 'white' },
                    endAdornment: (
